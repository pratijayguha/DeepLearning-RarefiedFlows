...
tuner = Hyperband(
    ...
    project_name='TemperatureOpti_hl'
    )
...
models[0].save('/mnt/IMP/Work/Thesis/NeuralNetwork/DeepLearning-RarefiedFlows/SavedModels/Temperature/HyperBand_hl/Best_Model_1/')
models[1].save('/mnt/IMP/Work/Thesis/NeuralNetwork/DeepLearning-RarefiedFlows/SavedModels/Temperature/HyperBand_hl/Best_Model_2')
